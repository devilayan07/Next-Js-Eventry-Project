  ...
  return (
    <section className="container">
      <div className="bg-gradient-to-b from-slate-200/20 to-slate-800/30">
        <Image src={eventInfo?.imageUrl} alt={eventInfo?.name} className="h-[450px] mx-auto" width={900} height={900}/>
      </div>
      ...
      <div className="flex items-end">
        <div className="flex-auto py-4">
         ...
         <ActionButtons fromDetails={true} eventId={eventInfo?.id} interestedUsersIds={eventInfo?.interested_ids} goingUserIds={eventInfo?.going_ids}/>
      </div>
    </section>  )
}
